...
class miHandler(SocketServer.BaseRequestHandler):
	...
	def handle(self):
		...
		self.respuesta = str(potencia(float(self.palabra1), float(self.palabra3)))
		print 'los numeros recibidos son: ' , self.palabra1, 'y', self.palabra3, 'y la potencia', self.respuesta
